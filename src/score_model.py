...
Code adapted by <gabriela.damas@estudiante.uam.es> and <eva.blazquez@estudiante.uam.es> 
from alberto.suarez@uam.es (original from https://yang-song.net/blog/2021/score/)
"""
...
class ScoreNet(nn.Module):
  ...
  def __init__(self, marginal_prob_std, in_channels=1, out_channels=1, channels=(32, 64, 128, 256), embed_dim=256):
    ...
    # Se añade padding=1 para mantener dimensiones compatibles con 64x64
    ...
    self.tconv1 = nn.ConvTranspose2d(channels[0] + channels[0], out_channels, 3, stride=1, padding=1)
